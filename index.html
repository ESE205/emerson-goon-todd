...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="http://http://www.mybusybear.com" class="w3-bar-item w3-button w3-padding-large w3-white">Home</a>
    <a href="http://http://www.mybusybear.com/BusyBear_Olin.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Olin</a>
    <a href="http://http://www.mybusybear.com/AddTest.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Test Add</a>
