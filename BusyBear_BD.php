...
<footer class="w3-container w3-padding-64 w3-center w3-opacity">  
  <div class="w3-xlarge w3-padding-32">
    <i class="fa fa-facebook-official w3-hover-opacity" <a href="www.linkedin.com/in/ThomasGEmerson"</a>></i>
    <i class="fa fa-instagram w3-hover-opacity" <a href="www.linkedin.com/in/ThomasGEmerson"</a>></i>
    <i class="fa fa-snapchat w3-hover-opacity" <a href="www.linkedin.com/in/ThomasGEmerson"</a>></i>
    <i class="fa fa-pinterest-p w3-hover-opacity" <a href="www.linkedin.com/in/ThomasGEmerson"</a>></i>
    <i class="fa fa-twitter w3-hover-opacity" <a href="www.linkedin.com/in/ThomasGEmerson"</a>></i>
    <i class="fa fa-linkedin w3-hover-opacity" <a href="www.linkedin.com/in/ThomasGEmerson"</a>></i>
 </div>
 <p>Powered by <a href="www.linkedin.com/in/ThomasGEmerson" target="_blank">Emerson Industrial</a></p>
</footer>
